...
Options:
    ...
    --image-root PATH            Override image root directory
                                 (default: data/raw/crops/Crop_224_5fp_100K)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""
            Examples:
              ...
              python -m scripts.analysis.analyze_val_predictions \\
                  --experiment-dir outputs/experiments/<run_id> \\
                  --image-root /data/raw/crops/Crop_224_5fp_100K
    ...
    parser.add_argument(
        ...
        default="data/raw/crops/Crop_224_5fp_100K",
        metavar="PATH",
        help="Root directory for image lookup (default: data/raw/crops/Crop_224_5fp_100K)",
    )
    parser.add_argument(
        "--no-image-grids",
        action="store_true",
